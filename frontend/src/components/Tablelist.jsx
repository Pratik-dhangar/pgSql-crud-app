      ...
      <table className="table w-full block md:table">
        ...
        <thead className="block md:table-header-group">
          <tr className="  md:border-none block md:table-row absolute -top-full md:top-auto -left-full md:left-auto md:relative">
            <th className=" p-2  font-bold md:border md:border-grey-500 text-center block md:table-cell">Id</th>
            <th className=" p-2  font-bold md:border md:border-grey-500 text-center block md:table-cell">Name</th>
            <th className=" p-2  font-bold md:border md:border-grey-500 text-center block md:table-cell">Email</th>
            <th className=" p-2  font-bold md:border md:border-grey-500 text-center block md:table-cell">Job</th>
            <th className=" p-2  font-bold md:border md:border-grey-500 text-center block md:table-cell">Rate</th>
            <th className=" p-2  font-bold md:border md:border-grey-500 text-center block md:table-cell">Status</th>
            <th className="p-2  font-bold md:border md:border-grey-500 text-center block md:table-cell" colSpan="2">Actions</th>
          </tr>
        </thead>
        <tbody className="block md:table-row-group">
          {filteredData.map((client) => (
            ...
            <tr key={client.id} className=" border border-grey-500 md:border-none block md:table-row mb-4 md:mb-0">
              ...
              <td data-label="Name" className="p-2 md:border md:border-grey-500 text-center block md:table-cell">
                  <span className="inline-block w-1/3 md:hidden font-bold">Name</span>{client.name}
              </td>
              <td data-label="Email" className="p-2 md:border md:border-grey-500 text-center block md:table-cell">
                  <span className="inline-block w-1/3 md:hidden font-bold">Email</span>{client.email}
              </td>
              <td data-label="Job" className="p-2 md:border md:border-grey-500 text-center block md:table-cell">
                  <span className="inline-block w-1/3 md:hidden font-bold">Job</span>{client.job}
              </td>
              <td data-label="Rate" className="p-2 md:border md:border-grey-500 text-center block md:table-cell">
                  <span className="inline-block w-1/3 md:hidden font-bold">Rate</span>{client.rate}
              </td>
              <td data-label="Status" className="p-2 md:border md:border-grey-500 text-center block md:table-cell">
              ...
              <td data-label="Update" className="p-2 md:border md:border-grey-500 text-center block md:table-cell">
              ...
              <td data-label="Delete" className="p-2 md:border md:border-grey-500 text-center block md:table-cell">
